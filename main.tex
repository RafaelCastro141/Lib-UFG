...
\tableofcontents{}
    ...
    \section{Treap}
    \lstinputlisting{./solutions/Treap.cpp}
    \newpage
    \section{Segment Tree}
    \subsection{Simple Segment}
    \lstinputlisting{./solutions/segtree.cpp}
    \newpage
    \subsection{Segment with Lazy}
    \lstinputlisting{./solutions/segtreelazy.cpp}
    \newpage
    ...
    \newline 
    Queries in $O(log(n))$
    \lstinputlisting{./solutions/persistent_segtree.cpp}
